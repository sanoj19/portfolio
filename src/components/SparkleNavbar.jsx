 ...
 * Adapted for the portfolio project with scroll-to-section functionality.
 */
const SparkleNavbar = ({ 
  items, 
  color = "#3b82f6", // Using your portfolio's primary color
  onItemClick 
}) => {
  ...
  const createSVG = (element) => {
    ...
    <div class="strike">
      <svg viewBox="0 0 114 12" preserveAspectRatio="none">
        <g fill="none" stroke="#f9fafb" stroke-width="0.75" stroke-linecap="round">
